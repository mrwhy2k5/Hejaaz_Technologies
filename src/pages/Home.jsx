...
export default function Home() {
  return (
    <Layout>
      ...
      <section className="bg-[var(--bg-main)] section-padding border-b border-hejaaz-border relative overflow-hidden no-scrollbar transition-colors duration-500">
      ...
      <section className="section-padding bg-[var(--bg-main)] overflow-hidden no-scrollbar transition-colors duration-500">
        <div className="container-content">
      ...
      <section className="section-padding bg-[var(--bg-secondary)] border-y border-hejaaz-border overflow-hidden no-scrollbar transition-colors duration-500">
        <div className="container-content">
      ...
      {/* ============ LEVEL 6: BANNER ============ */}
      <section className="bg-hejaaz-secondary py-16 sm:py-24 lg:py-32 text-white relative overflow-hidden no-scrollbar transition-colors duration-500">
