        ...
        <div className="container-content">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-24 items-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-7xl font-black tracking-tighter leading-[0.95] transition-colors heading-reveal uppercase mb-6 sm:mb-10">
                Critical Safety <br />Integration <span className="text-hejaaz-secondary">Across Sectors.</span>
              </h1>
              <p className="text-base sm:text-xl lg:text-2xl text-[var(--text-muted)] font-bold uppercase tracking-tight max-w-3xl leading-tight transition-colors">
        ...
        <div className="container-content">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-16 gap-8">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black tracking-tighter leading-none heading-reveal uppercase">Verified Sectors.</h2>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {industriesData.map((ind, i) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-8 bg-hejaaz-surface border border-hejaaz-border group-hover:bg-hejaaz-secondary group-hover:text-white transition-all duration-500 shadow-sm">
          ...
          >
            <div className="bg-hejaaz-secondary p-6 sm:p-12 lg:p-24 rounded-2xl sm:rounded-[3rem] text-white relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 max-w-3xl">
                <h2 className="text-3xl sm:text-4xl lg:text-7xl font-black mb-6 sm:mb-10 text-white tracking-tighter leading-[0.95] uppercase">Serving Your <br />Specific Sector.</h2>
                <p className="text-white/80 text-base sm:text-xl lg:text-2xl mb-8 sm:mb-12 font-bold uppercase tracking-tight leading-tight">
