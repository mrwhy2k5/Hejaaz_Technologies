            ...
            <div className="grid lg:grid-cols-12 gap-16 lg:items-start">
              ...
              >
                ...
                >
                  ...
                  <div className="relative p-0 lg:p-4 transition-all duration-500">
                    <img
                      src={manual.heroImage || manual.systemLayout?.image || "/images/products/placeholder.svg"}
                      alt={manual.name}
                      className="w-full h-auto object-contain max-h-[700px] rounded-2xl transition-all duration-700 group-hover:scale-105 mix-blend-multiply dark:mix-blend-normal"
                    />
