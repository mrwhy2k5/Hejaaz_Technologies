        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12 items-start">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href="https://wa.me/919361227290" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#25D366] flex items-center justify-center transition-all duration-300" aria-label="WhatsApp">
